...
(async function() {
    ...
    FastTagScraper.configure({
        ...
        parseDurationSec,
        getScraperMatchingSettings,
        getDefaultScraperSource: () => getDefaultScraperSource(),
        getActiveScraperSource: () => getActiveScraperSource(),
        setActiveScraperSource: (id) => setActiveScraperSource(id),
        getAllowStashBoxFallback: () => getAllowStashBoxFallback(),
        getFillMissingPerformerImages,
    ...
    FastTagScraperController.configure({
        ...
        loadScraperSources: (...args) => loadScraperSources(...args),
        resolveActiveSource: (...args) => resolveActiveSource(...args),
        getActiveScraperSource: () => getActiveScraperSource(),
        setActiveScraperSource: (id) => setActiveScraperSource(id),
        analyzeScraperMatch,
        getScraperResultUrl,
    ...
    console.log('[FastTag v4.5.1] Initialized with Targeted Apollo Cache Sync, IndexedDB Cache, and 0ms Scene Card Updates');
    ...
    function loadFastTagHelpModule() {
        ...
        fastTagHelpLoadPromise = new Promise((resolve, reject) => {
            ...
            const attemptLoad = (index) => {
                ...
                scriptUrl.searchParams.set('v', '4.5.1-help-1');
