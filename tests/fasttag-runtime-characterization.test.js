...
const source = fs.readFileSync(path.join(repositoryRoot, 'fasttag.js'), 'utf8');
const previewSource = fs.readFileSync(path.join(repositoryRoot, 'fasttag-preview.js'), 'utf8');
const scraperControllerSource = fs.readFileSync(path.join(repositoryRoot, 'fasttag-scraper-controller.js'), 'utf8');
const popupSource = fs.readFileSync(path.join(repositoryRoot, 'fasttag-popup.js'), 'utf8');
const editorSource = fs.readFileSync(path.join(repositoryRoot, 'fasttag-editors.js'), 'utf8');
