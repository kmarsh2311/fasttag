...
const source = fs.readFileSync(path.resolve(__dirname, '..', 'fasttag-settings.js'), 'utf8');
const appended = [];
const root = {
    FastTag: {},
    console: { warn() {} },
...
assert.match(source, /fasttag-setting-default-scraper-btn/, "settings should provide a compact default scraper button");
assert.match(source, /fasttag-settings-source-dropdown-menu/, "settings should provide a compact searchable scraper dropdown menu");
