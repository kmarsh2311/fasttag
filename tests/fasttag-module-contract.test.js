...
const pluginDirectory = repositoryRoot;
...
assert.ok(mainSource.includes("scriptUrl.searchParams.set('v', '4.4.9-help-1')"), 'optional help should use the current release cache key so updated guide code is loaded');
