(function initializeFastTagEntities(root) {
    ...
    const ENTITY_CONFIG = {
        tags: {
            ...
            countQuery: 'query { findTags(filter: { per_page: 0 }) { count } }',
            extractCount: data => data?.findTags?.count,
        ...
        performers: {
            ...
            countQuery: 'query { findPerformers(filter: { per_page: 0 }) { count } }',
            extractCount: data => data?.findPerformers?.count,
        ...
        galleries: {
            ...
            countQuery: 'query { findGalleries(filter: { per_page: 0 }) { count } }',
            extractCount: data => data?.findGalleries?.count,
        ...
        studios: {
            ...
            countQuery: 'query { findStudios(filter: { per_page: 0 }) { count } }',
            extractCount: data => data?.findStudios?.count,
        ...
        groups: {
            ...
            countQuery: 'query { findGroups(filter: { per_page: 0 }) { count } }',
            fallbackCountQuery: 'query { findMovies(filter: { per_page: 0 }) { count } }',
            extractCount: data => (data?.findGroups?.count ?? data?.findMovies?.count),
